...
public class LogHandlerAdviser {
    ...
    @Pointcut("execution(* com.gongyu.application.distribute.game.controller.*.*(..)) && !execution(* com.gongyu.application.distribute.game.controller.admin.AliyunFileController.*(..))")
