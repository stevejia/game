...
import com.futures.model.dto.UserLogExportExcel;
...
public class SysUserLogController {
    ...
    public void exportUserLog(@ApiParam(value = "操作人") String userName,
        ...
        try{
            ...
            int count = 1;
            List<com.futures.model.entity.SysUserLog> sysUserLogList = sysUserFpi.exportSysUserLog(userName, modelName, argument, startTime, endTime);
            for (com.futures.model.entity.SysUserLog sysUserLog : sysUserLogList) {
