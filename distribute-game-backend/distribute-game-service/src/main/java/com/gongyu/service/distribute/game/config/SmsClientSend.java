package com.gongyu.service.distribute.game.config;

import com.gongyu.service.distribute.game.utils.SmsClientAccessTool;
...
public class SmsClientSend {
    ...
    public String sendSms(String mobile, String content) {
        ...
        String userid = "3699";
        String account = "qx4307";
        String password = "20200331";
        String post = sendSms(url, userid, account, password, mobile, content, null,
