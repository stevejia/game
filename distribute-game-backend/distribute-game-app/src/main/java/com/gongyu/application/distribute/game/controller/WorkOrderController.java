...
public class WorkOrderController {
    ...
    @ApiOperation(value = "【工单中心】列表", notes = "【工单中心】列表", response = WorkOrderSaveDto.class)
    ...
    public BaseResponse queryWorkOrder(Page page, @Valid @ModelAttribute WorkOrderSaveDto workOrderSaveDto) {
        workOrderSaveDto.setUserId(WebUtils.getCurrentUserId());
        return BaseResponse.success(workOrderService.queryWorkOrder(page, workOrderSaveDto));
    }

    @ApiOperation(value = "【工单中心】详情", notes = "【工单中心】详情", response = WorkOrder.class)
    ...
    @ApiOperation(value = "【工单中心】添加", notes = "【工单管理】添加")
    ...
    @ApiOperation(value = "【工单中心】修改", notes = "【工单管理】修改")
    ...
    @ApiOperation(value = "【工单中心】删除", notes = "【工单管理】删除")
